...
func (SmsCpMsg SmsCpMsg) Short() string {
	top := 50
	if len(SmsCpMsg.MsgText) > top {
		return SmsCpMsg.MsgText[:top] + "..."
	}
	return SmsCpMsg.MsgText
}

func (SmsCpMsg SmsCpMsg) Text() string  { return SmsCpMsg.MsgText }
